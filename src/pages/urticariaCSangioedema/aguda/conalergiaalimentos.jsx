...
function UrticariaConAlergiaAlimentosPage() {
    ...
    const pageSteps = [
        ...
        {title: "Asociada a alimentos", active: false},
    ];
    ...
    return <ComplexLayout steps={pageSteps}>
        <div className={"w-full mb-4"}>
            ...
            <div className={"text-center text-2xl sm:text-3xl m-5 text-secondary font-bold"}>
                <h1>Urticaria asociada a alimentos</h1>
            </div>
            <div className={"text-justify p-4"}>
                <p>
                    Reacción adversa desencadenada por un antígeno alimentario específico.
                    Es reproducible (es decir, siempre que se expone se presentan los síntomas).
                    <br/>
            ...
            <div className={"text-justify p-4"}>
                <ul className={"list-decimal space-y-2 list-inside"}>
                    ...
                    <li>
                        Interrogar asociación tras el consumo de alimentos ricos en histamina.
                    </li>
                    <li>
                        Referir al alergólogo para determinar perfil de sensibilización alérgica y/o
                        prueba de provocación en caso necesario, así como dietas de exclusión.
                    </li>
                </ul>
            </div>
            <div className={"grid grid-cols-1 grid-rows-1 sm:grid-cols-2 gap-4"}>
                <div>
                    <button
                        ...
                        onClick={() => history.push("/urticaria-cs-angioedema/aguda/alergia/alimentos/abordaje")}>
...
export default React.memo(UrticariaConAlergiaAlimentosPage);