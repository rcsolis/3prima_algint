...
import Image1 from "../../../assets/images/cronica/cebada.png"
import Image1s2 from "../../../assets/images/cronica/cebada@2x.png";
import ImageCardComponent from "../../../components/cards/ImageCardComponent";


function UrticariaCronicaDiagnosticosCebadaPage(){
        ...
        <div className={"w-full h-full bg-primary-gradient text-white rounded-2xl p-5"}>
            ...
            <div className={"text-center mb-10"}>
                <h1 className={"font-bold text-lg sm:text-xl"}>
                    Síndrome de activación de la célula cebada
                </h1>
            </div>
...
export default React.memo(UrticariaCronicaDiagnosticosCebadaPage);