...
import Image1 from "../../../assets/images/cronica/well.png"
import Image1s2 from "../../../assets/images/cronica/well@2x.png";
import ImageCardModalComponent from "../../../components/cards/ImageCardModalComponent";


function UrticariaCronicaDiagnosticosWellPage(){
            ...
            <div className={"max-w-full h-auto"}>
                <ImageCardModalComponent imageName={Image1} imageName2={Image1s2}>
                    <div className={"text-center font-bold"}>
                        <p>
                            Adermatitis granulomatosa con celulitis eosinofílica, eosinofilia.
                        </p>
                    </div>
...
export default React.memo(UrticariaCronicaDiagnosticosWellPage);