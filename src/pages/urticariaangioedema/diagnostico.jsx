...
function UrticariaAngioedemaDiagnosticoPage(){
    ...
    return <ComplexLayout steps={pageSteps}>
        <div className={"w-full mb-4"}>
            ...
            <div className={"text-center text-2xl sm:text-3xl mx-5 my-2 text-yellow-400 font-bold"}>
                <h1>Angioedema Hereditario</h1>
            </div>
            <div className={"text-xl sm:text-2xl mx-5 my-2 text-yellow-400 font-bold"}>
