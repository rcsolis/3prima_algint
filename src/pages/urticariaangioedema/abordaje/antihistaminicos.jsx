...
function UrticariaAngioedemaAbordajeAntihistaminicosPage(){
    ...
    return <ComplexLayout steps={pageSteps}>
        <div className={"w-full mb-4"}>
            ...
            <div className={"p-4 mb-4"}>
                ...
                Continuar con abordaje inicial de <strong>Urticaria</strong>.
            </div>
...
export default React.memo(UrticariaAngioedemaAbordajeAntihistaminicosPage);